        ...
        <div id="conteneur">
            <div class="element">                                                       <!--phase 1-->
                ...
                <p>
                    ...
                    <input type="radio" name="freqlumineux" value="rythmee" id="rythmee"/><label for="aleatoire"><?php echo _EMIS_RYTHME; ?></label>
                </p>
            </div>
            ...
            <div class="element">                           <!--phase 2-->
                ...
                <p>
                    <input type="radio" name="freqlumineux2" value="aleatoire" id="aleatoire2"/><label for="aleatoire"><?php echo _EMIS_ALEATOIRE; ?></label><br/>
